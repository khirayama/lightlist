...
export const TaskListPanel = memo(
  ({
    t,
    theme,
    tasks,
    ...
    const canAddTask = !addDisabled && newTaskText.trim().length > 0;
    ...
    const [datePickerTaskId, setDatePickerTaskId] = useState<string | null>(
      null,
    );
    ...
    const applyDateChange = useCallback(
      ...
      [editingTaskId, onEditingTaskDateChange, onDateChange],
    );
    ...
    const confirmDeleteCompletedTasks = useCallback(() => {
    ...
    }, [completedTasksCount, t, onDeleteCompletedTasks]);
                ...
                <View style={styles.taskRow}>
                  ...
                  >
                    <AppIcon
                      ...
                      size={18}
                      color={
                        canDragTask && !isEditing ? theme.text : theme.muted
                      }
                    />
                  </Pressable>
                  <Pressable
                  ...
                  <View style={styles.taskContent}>
                    {isEditing ? (
                      <TextInput
                        ...
                        autoCorrect={false}
                        returnKeyType="done"
                        onSubmitEditing={() => onEditEnd(item)}
