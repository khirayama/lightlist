...
- アプリアイコン/スプラッシュ画像は `apps/native/assets`（`icon.png` / `adaptive-icon.png` / `splash-icon.png`）を正本とし、必要に応じて `ios/LightlistDev/Images.xcassets` と `android/app/src/main/res` の生成済み画像を同じロゴで更新する
