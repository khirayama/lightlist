  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button:
          "h-9 w-9 rounded-lg p-0 font-medium text-gray-900 hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400 dark:text-gray-50 dark:hover:bg-gray-800 dark:focus-visible:outline-gray-500",
        selected:
